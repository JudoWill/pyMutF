...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Query.LastChecked'
        db.alter_column('Queries_query', 'LastChecked', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Query.LastChecked'
        db.alter_column('Queries_query', 'LastChecked', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'Queries.query': {
            ...
            'LastChecked': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
