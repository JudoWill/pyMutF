...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MutationAnnot'
        db.create_table('Annot_mutationannot', (
        ...
        db.send_create_signal('Annot', ['InteractionEffectAnnot'])


    def backwards(self, orm):
        
        # Deleting model 'MutationAnnot'
        db.delete_table('Annot_mutationannot')

        # Deleting model 'InteractionEffectAnnot'
        db.delete_table('Annot_interactioneffectannot')
