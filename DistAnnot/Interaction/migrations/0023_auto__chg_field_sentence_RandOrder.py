...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sentence.RandOrder'
        db.alter_column('Interaction_sentence', 'RandOrder', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Sentence.RandOrder'
        db.alter_column('Interaction_sentence', 'RandOrder', self.gf('django.db.models.fields.IntegerField')(null=True))
