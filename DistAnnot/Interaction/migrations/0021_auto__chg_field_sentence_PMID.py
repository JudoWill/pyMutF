...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sentence.PMID'
        db.alter_column('Interaction_sentence', 'PMID', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Sentence.PMID'
        db.alter_column('Interaction_sentence', 'PMID', self.gf('django.db.models.fields.IntegerField')())
