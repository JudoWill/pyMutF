...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sentence.ParNum'
        db.add_column('Interaction_sentence', 'ParNum', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sentence.ParNum'
        db.delete_column('Interaction_sentence', 'ParNum')
