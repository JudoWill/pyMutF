...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Interaction_sentence', 'Priority', self.gf('django.db.models.fields.IntegerField')(default=None, null=True), keep_default=False)

        # Adding field 'Sentence.RandOrder'
        db.add_column('Interaction_sentence', 'RandOrder', self.gf('django.db.models.fields.IntegerField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sentence.Priority'
        db.delete_column('Interaction_sentence', 'Priority')

        # Deleting field 'Sentence.RandOrder'
        db.delete_column('Interaction_sentence', 'RandOrder')
    ...
    models = {
        ...
        'Interaction.sentence': {
            ...
            'RandOrder': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
