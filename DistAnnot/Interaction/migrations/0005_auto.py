...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field Mutation on 'Sentence'
        db.create_table('Interaction_sentence_Mutation', (
        ...
        db.create_unique('Interaction_sentence_Mutation', ['sentence_id', 'mutation_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field Mutation on 'Sentence'
        db.delete_table('Interaction_sentence_Mutation')
