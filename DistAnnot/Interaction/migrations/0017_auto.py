...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field Interactions on 'Article'
        db.create_table('Interaction_article_Interactions', (
        ...
        db.create_unique('Interaction_article_Interactions', ['article_id', 'interaction_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field Interactions on 'Article'
        db.delete_table('Interaction_article_Interactions')
