...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('Interaction_article', 'Title', self.gf('django.db.models.fields.TextField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.Title'
        db.delete_column('Interaction_article', 'Title')
