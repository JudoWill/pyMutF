...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('Interaction_reference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('Article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Interaction.Article'])),
            ('Mutation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Interaction.Mutation'])),
            ('Tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Interaction.MutationTags'])),
        ))
        db.send_create_signal('Interaction', ['Reference'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('Interaction_reference')
    ...
    models = {
        ...
        'Interaction.mutation': {
            'Descriptions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['Interaction.MutationTags']", 'through': "orm['Interaction.Reference']", 'symmetrical': 'False'}),
        ...
        'Interaction.reference': {
            'Article': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Interaction.Article']"}),
            'Meta': {'object_name': 'Reference'},
            'Mutation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Interaction.Mutation']"}),
            'Tag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Interaction.MutationTags']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
