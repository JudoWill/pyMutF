...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Mutation.Gene'
        db.alter_column('Interaction_mutation', 'Gene_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['Interaction.Gene']))
    ...
    models = {
        ...
        'Interaction.mutation': {
            'Gene': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['Interaction.Gene']", 'blank': 'True'}),
