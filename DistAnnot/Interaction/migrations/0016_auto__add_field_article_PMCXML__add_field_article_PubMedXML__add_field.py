...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Article.PMCXML'
        db.add_column('Interaction_article', 'PMCXML', self.gf('django.db.models.fields.XMLField')(default=None, null=True), keep_default=False)
        ...
        db.add_column('Interaction_article', 'HasMut', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Article.PMCXML'
        db.delete_column('Interaction_article', 'PMCXML')

        # Deleting field 'Article.PubMedXML'
        db.delete_column('Interaction_article', 'PubMedXML')

        # Deleting field 'Article.HasMut'
        db.delete_column('Interaction_article', 'HasMut')
