...
pip install -e git+git://github.com/davedash/django-fixture-magic#egg=django_fixture_magic
pip install -e git+git://github.com/cmheisel/nose-xcover.git#egg=nosexcover
